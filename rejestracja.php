...
<main class="container py-5" style="border-radius: 12px;">
    <div class="row align-items-center justify-content-center">
        ...
        <div class="col-12 col-md-6 text-center text-md-start mb-4 mb-md-0 text-white slide-in-left">
            ...
            <p class="lead mb-4">
                Register now for our <strong>IB Conference</strong>! Click the button below to access the registration form, where you’ll find all the details about participation.
            </p>
