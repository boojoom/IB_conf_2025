...
$lang = array(
    ...
    "welcome_text_2" => "Podczas wykładów i dyskusji poszerzysz swoją wiedzę, poznasz najnowsze trendy w inżynierii biomedycznej i dowiesz się, jak możesz rozwijać swoją karierę naukową. Mamy nadzieję, że to właśnie tu znajdziesz motywację do podjęcia nowych wyzwań badawczych! Dołącz do nas! Wystarczy wypełnić formularz rejestracyjny. Widzimy się już <strong>23 czerwca 2025 roku w budynku D20 przy ulicy Zygmunta Janiszewskiego 8!</strong>",

    "announcements" => "Aktualności",
    "announcement_1_title" => "📅 Otwarcie rejestracji",
    "announcement_1_text" => "Rejestracja na konferencję CYBER rozpocznie się <strong>15 maja</strong>. Zachęcamy do wcześniejszego zgłoszenia! Informacje na temat akceptacji zgłoszenia zostaną przekazane do <strong>10 czerwca</strong>. Bonus - konferencja jest <strong>bezpłatna</strong>!",
    ...
    "session1" => "Pierwsza sesja prezentacyjna",
    "coffee" => "Przerwa kawowa",
    "session2" => "Druga sesja prezentacyjna",
    "session3" => "Trzecia sesja prezentacyjna <br><span class='text-muted'>(7/8 prezentacji)</span>",
    "lunch" => "<strong>Lunch</strong> <br><span class='text-muted'>(tylko dla prelegentów i profesorów)</span>",
    "session4" => "Czwarta sesja prezentacyjna <br><span class='text-muted'>(7/8 prezentacji)</span>",
