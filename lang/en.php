...
$lang = array(
    ...
    "welcome_text_1" => "We invite you to the <strong style='color: #1FA53E;'>CYBER</strong> PhD Conference — a unique event bringing together young researchers, PhD students, undergraduate students, and specialists in the field of biomedical engineering. Our interests span neuroscience, optics, medical imaging, bioinformatics, drug design, biomaterials, and antimicrobial technologies. CYBER is a platform for sharing knowledge and experience gained through interdisciplinary scientific work. We aim to showcase the latest research achievements from our Department and inspire young scientists to embark on their own PhD journey.",
    ...
    "lunch" => "<strong>Lunch</strong> <br><span class='text-muted'>(for speakers and invited speakers only)</span>",
    ...
    "registration_intro" => "Register to <strong style='color: #1FA53E;'>CYBER</strong> now! Click the button below to access the registration form, where you’ll find all the details about participation.",
